...
public final class LoginPageBinding implements ViewBinding {
  ...
  private LoginPageBinding(@NonNull LinearLayout rootView, @NonNull EditText emailText,
      @NonNull Button login, @NonNull EditText passwordText) {
  ...
  public static LoginPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LoginPageBinding((LinearLayout) rootView, emailText, login, passwordText);
    }
