...
// Test time is badly formatted
@RunWith(AndroidJUnit4.class)
@LargeTest
public class AddReminderInvalidTest1 {
    ...
    public void testAddReminderSuccess() {
        ...
        onView(withId(R.id.hourAndMinuteText))
                .perform(typeText("25:61"), closeSoftKeyboard());
        onView(withId(R.id.addReminder2))
                .perform(click());
        wait(3000);
        onView(withId(R.id.hourAndMinuteText)).check(matches(hasErrorText("Time is badly formatted!")));
    }
}